...
struct CircuitDatabase {
    static let circuits: [CircuitInfo] = [
        ...
        CircuitInfo(circuitId: "ESP", length: "4.657 km", turns: 16, lapRecord: "1:16.330", lapRecordHolder: "Max Verstappen",       lapRecordYear: 2023, latitude:  41.5700, longitude:   2.2611),
        ...
        CircuitInfo(circuitId: "BEL", length: "7.004 km", turns: 19, lapRecord: "1:46.286", lapRecordHolder: "Valtteri Bottas",      lapRecordYear: 2018, latitude:  50.4372, longitude:   5.9714),
        ...
        CircuitInfo(circuitId: "ITA", length: "5.793 km", turns: 11, lapRecord: "1:21.046", lapRecordHolder: "Rubens Barrichello",   lapRecordYear: 2004, latitude:  45.6156, longitude:   9.2811),
        ...
        CircuitInfo(circuitId: "SGP", length: "4.940 km", turns: 19, lapRecord: "1:35.867", lapRecordHolder: "Lewis Hamilton",       lapRecordYear: 2023, latitude:   1.2914, longitude: 103.8636),
        ...
        CircuitInfo(circuitId: "LVG", length: "6.201 km", turns: 17, lapRecord: "1:35.490", lapRecordHolder: "Oscar Piastri",        lapRecordYear: 2024, latitude:  36.1147, longitude: -115.1728),
        CircuitInfo(circuitId: "QAT", length: "5.380 km", turns: 16, lapRecord: "1:24.319", lapRecordHolder: "Max Verstappen",       lapRecordYear: 2023, latitude:  25.4900, longitude:  51.4542),
        CircuitInfo(circuitId: "ABU", length: "5.281 km", turns: 16, lapRecord: "1:26.103", lapRecordHolder: "Max Verstappen",       lapRecordYear: 2021, latitude:  24.4672, longitude:  54.6031),
    ]
